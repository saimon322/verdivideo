...
gulp.task('scripts', function () {
  return gulp
    .src([
      ...
      'app/libs/forms/imask.min.js',
      'app/libs/forms/payform.min.js',
      'app/libs/mousewheel.min.js',
      'app/libs/ie/ofi.min.js',

      'app/js/basket.min.js',
...
gulp.task('watch', function () {
  ...
  gulp.watch(['libs/**/*.js', 'app/js/common.js', 'app/js/basket.js'], gulp.parallel('scripts'));
